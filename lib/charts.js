...
function getGradientFunctions(width, height) {
  ...
  // colors: an array of objects each containing:
  //  {
  //    color: string,  // The color value
  //    offset: number, // A number between 0 and 1 indicating the color's position in the gradient
  //  }
  const getGradientFillHelper = (direction, colors, dimensions = {}) => {
    ...
    return getGradientFill(colors, linearGradient);
  };
